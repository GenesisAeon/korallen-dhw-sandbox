  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "NOAA DHW Bleaching-Sandbox: fünf Alert-Stufen, vier globale Ereignisse, Recovery-Fenster Hughes vs. GCRMN. Keine UTAC-Brücke, keine erfundene Γ.",
      },
